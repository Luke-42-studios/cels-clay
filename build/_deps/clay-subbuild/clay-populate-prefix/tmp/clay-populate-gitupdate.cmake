...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v0.14"
  WORKING_DIRECTORY "/home/cachy/workspaces/libs/cels/modules/cels-clay/build/_deps/clay-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v0.14" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v0.14")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v0.14")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v0.14\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/cachy/workspaces/libs/cels/modules/cels-clay/build/_deps/clay-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/cachy/workspaces/libs/cels/modules/cels-clay/build/_deps/clay-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
